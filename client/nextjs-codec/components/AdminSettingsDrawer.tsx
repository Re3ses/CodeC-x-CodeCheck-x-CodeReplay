...
export default function AdminSettingsDrawer() {
  ...
  return (
    <Drawer>
      <DrawerTrigger className="px-4 py-2 border rounded-lg bg-zinc-700 hover:bg-zinc-500">
        Admin settings
      </DrawerTrigger>
      <DrawerContent>
        <DrawerHeader>
        ...
        <div className="flex gap-4 p-4">
          ...
          <div className="border rounded-lg overflow-scroll">
            <p className="p-4 bg-zinc-900 rounded-t-lg text-lg sticky top-0">
              Current connected students
            </p>
