...
export async function setSecureCookie(name, value, expiryDate) {
    cookies().set({
        name: name,
        value: value,
        path: "/",
...
export async function RegisterUser(payload) {
    ...
    const alreadyExists = await axios
        .get(`${url}validate?username=${payload.username}&email=${payload.email}`)
        .then(res => {
            return res.data
        })
        .catch(err => {
...
export async function ChangePass(password, new_password) {
...
export async function GetMentorRooms() {
    try {
        ...
        const res = await axios.get(url, { headers }).then(data => {
            return data
        })
        return res.data
    } catch (e) {
...
export async function GetProblemsMentor() {
    const username = await getUser().then(value => {
...
export async function GetProblems(slug) {
    await SilentLogin()
...
export async function PostProblem(rooms_slug, problems_slug) {
...
export async function RemoveProblem(rooms_slug, problems_slug) {
...
// ~~~ ENROLL ~~~
export async function GetEnrollees(slug) {
...
export async function Enroll(slug) {
    const user = await getUser()
...
export async function Unenroll(slug, username) {
