        ...
        <div className="h-screen">
            <PanelGroup autoSaveId="livecodepanels" direction="horizontal">
                <Panel
                    defaultSize={40}
                    minSize={20}
                    className="border-zinc-700 border-r-4"
                >
                    <div className="bg-zinc-900 p-5 flex flex-col gap-4 justify-center">
                        <AdminSettingsDrawer />
                        <div className="flex flex-col gap-3">
                            {liveCodeQuery.data?.liveCode_requests.map(request => (
                        ...
                        <Panel minSize={20} className="">
                            <div className="flex">
                                <div className="flex gap-2 border-r-4 border-zinc-800 my-auto px-4">
                                    <p className="border whitespace-nowrap h-fit rounded-lg px-4 py-2 hover:bg-rose-900">
                                        Search
                                    </p>
                                    <p className="border whitespace-nowrap h-fit rounded-lg px-4 py-2 hover:bg-rose-900">
                                        Blind
