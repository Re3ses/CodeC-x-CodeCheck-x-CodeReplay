...
export default function Page() {
    ...
    async function sendLiveCodeRequest(event: FormEvent<HTMLFormElement>) {
        ...
        if (hasSubmittedRequest) {
            toast({ title: "Oops, can only submit one request", variant: "destructive" });
            return;
        }
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            ...
                            <form onSubmit={sendLiveCodeRequest}>
                                <Textarea name="request_reason" placeholder="optional: reason (i.e., 'How to use callback funtions?')" />
